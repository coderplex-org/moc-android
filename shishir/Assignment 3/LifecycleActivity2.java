...
public class LifecycleActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displayStatus();
        TextView gotoActivity = (TextView) findViewById(R.id.textView4);
        gotoActivity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LifecycleActivity2.this,LifecycleActivity.class);
